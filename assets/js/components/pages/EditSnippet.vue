					...
					<div class="col">
						<div class="form-group">
							...
							<dropdown :label="(languages.filter(l => l.id === language)[0] ? languages.filter(l => l.id === language)[0].name : 'Language')"
								:options="languages" :onSelect="onLanguage" labelField="name" :selective="true"></dropdown>
						</div>
					</div>
					<div class="col">
						<div class="form-group">
							...
							<dropdown :label="(categories.filter(c => c.id === category)[0] ? categories.filter(l => l.id === category)[0].name : 'Type')"
								:options="categories" :onSelect="onCategory" :selective="true" labelField="name"></dropdown>
						</div>
					</div>
				</div>
